        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          {/* <View style={{ flex: 1, paddingTop: '10%', display: "flex", flexDirection: "column", justifyContent: "center" }}> */}
            <View style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center",marginTop:"20%"}}>
              ...
              style={{ backgroundColor: "#323D60", width: "70%", height: "13%", justifyContent: "center", alignItems: "center",marginTop:"10%",borderRadius:50 }}><Text style={{ color: "white" }}>Begin your food journey </Text></TouchableOpacity>
            {/* </View> */}
          </View>
        </ScrollView>
      </SafeAreaView>
